...
import {
    FaHotel, FaBed, FaMapMarkerAlt, FaRoute, FaStar, FaPhoneAlt,
...
export default function DetailsHotel() {
    ...
    const [subPart, setSubPart] = useState('hotels'); // 'hotels' හෝ 'rooms'
    ...
    // Backend එකෙන් අදාළ Hotel / Room විස්තර සහ Reviews ලබාගැනීම
    useEffect(() => {
        try {
        ...
        const fetchDetails = async () => {
            try {
                ...
                if (res.data && res.data.data) {
                    ...
                    setSubPart(res.data.data.category || 'hotels');
                ...
                <div className="fixed top-6 right-6 z-50 animate-bounce">
                    <div className={`flex items-center gap-3 px-5 py-3 rounded-2xl text-white font-medium shadow-2xl border ${
                        message.type === 'error'
                            ...
                            : 'bg-blue-600/90 border-blue-500 shadow-blue-900/50'
                    } backdrop-blur-md`}>
            ...
            {itemDetails ? (
                <div className="w-full bg-gray-900 border border-gray-800 rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    <div className="relative h-72 sm:h-96 md:h-[450px] w-full">
                        <img
                            src={itemDetails.image || 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=1200'}
                        ...
                        <div className="absolute bottom-6 left-6 right-6 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                            <div>
                                <span className="bg-blue-600 text-white text-[11px] font-bold px-3 py-1 rounded-full uppercase tracking-wider mb-2 inline-block">
                                ...
                                <p className="text-xs sm:text-sm text-gray-300 flex items-center gap-1.5 mt-1">
                                    <FaMapMarkerAlt className="text-blue-400" size={14} /> {itemDetails.location || 'Location not specified'}
                                </p>
                            </div>
                    ...
                    <div className="p-4 sm:p-6 md:p-10 space-y-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            <div className="bg-gray-950 border border-gray-800 p-4 rounded-2xl flex items-center gap-3">
                                <div className="p-3 bg-blue-600/10 text-blue-400 rounded-xl border border-blue-500/20"><FaCoins size={18} /></div>
                                <div>
                                    <p className="text-[11px] text-gray-400 font-medium">Price / Night</p>
                            ...
                            <div className="bg-gray-950 border border-gray-800 p-4 rounded-2xl flex items-center justify-between sm:col-span-2 md:col-span-1">
                                ...
                                <a
                                    ...
                                    className="bg-blue-600 hover:bg-blue-500 text-white px-3.5 py-2 rounded-xl text-xs font-bold transition shadow-md"
                                >
                                    Open Map
                                </a>
                            </div>
                        ...
                        <div className="bg-gray-950/60 border border-gray-800 p-6 rounded-2xl space-y-3">
                            <h2 className="text-base font-bold text-blue-400 flex items-center gap-2">
                                <FaInfoCircle size={16} /> About This Property
                            </h2>
                        ...
                        {/* 3. Room / Hotel Packages */}
                        <div className="space-y-4">
                            <h2 className="text-base font-bold text-blue-400 flex items-center gap-2">
                                <FaLayerGroup size={16} /> Room / Hotel Packages & Facilities
                            </h2>
                            {Array.isArray(itemDetails.menu) && itemDetails.menu.length > 0 ? (
                                    ...
                                    {itemDetails.menu.map((pkg, idx) => (
                                        <div key={idx} className="bg-gray-950 border border-gray-800 p-4 rounded-2xl space-y-2">
                                            <div className="flex justify-between items-start">
                                                ...
                                                <span className="text-xs bg-blue-600/20 text-blue-300 px-2 py-0.5 rounded-md font-semibold">{pkg.category || 'Standard'}</span>
                                            </div>
                                ...
                                <div className="bg-gray-950 border border-gray-800 p-4 rounded-2xl">
                                    <p className="text-xs font-semibold text-gray-300">Facilities Available:</p>
                        ...
                        <div className="space-y-6">
                            <div className="bg-gray-950 border border-gray-800 p-5 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-sm font-bold text-white">Verified Guest Experiences</h3>
                                        <p className="text-xs text-gray-400 mt-0.5">Share your feedback with other guests.</p>
                                    </div>
                                </div>
                                ...
                                <button
                                    ...
                                    className="bg-blue-600 hover:bg-blue-500 text-white px-5 py-2.5 rounded-xl text-xs font-bold cursor-pointer transition shadow-lg"
                                >
                            ...
                            {/* Review Form */}
                            {showReviewForm && (
                                <form onSubmit={handleReviewSubmit} className="bg-gray-950 border border-blue-500/30 p-6 rounded-2xl space-y-4 animate-fadeIn">
                                    <h3 className="text-sm font-bold text-blue-400">Add Your Review</h3>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs font-bold text-blue-400 ml-2">({ratingValue} / 5 Stars)</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Write about your stay/hotel experience here..."
                                            className="w-full bg-gray-900 border border-gray-800 rounded-xl p-3 text-xs text-white focus:outline-none focus:border-blue-500 transition"
                                            required
                                        ></textarea>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="bg-blue-600 hover:bg-blue-500 text-white px-5 py-2.5 rounded-xl text-xs font-bold transition flex items-center gap-2 cursor-pointer"
                                    >
                ...
                <div className="w-full bg-gray-900 border border-gray-800 p-12 rounded-3xl text-center space-y-4">
                    <p className="text-gray-400 text-sm">No hotel or room record selected.</p>
                    <button
                        onClick={() => navigate('/hotels')}
                        className="bg-blue-600 hover:bg-blue-500 text-white font-bold py-2.5 px-6 rounded-xl text-xs transition cursor-pointer"
                    >
                        Go Back to Hotels & Rooms
                    </button>
                </div>
            )}
        </div>
