...
import {
  FaUtensils, FaPlane, FaFilm, FaGift,
  FaArrowRight, FaFire, FaHotel
} from 'react-icons/fa';
...
const SERVICES = [
  ...
  },
  {
    id: 'hotels',
    label: 'HOTELS',
    subtitle: 'Luxury stays & experiences',
    icon: <FaHotel />,
    img: 'https://i.pinimg.com/1200x/a1/79/3f/a1793fe559bc34115f4f18e4890c32a6.jpg',
...
const ServiceCard = ({ service, index }) => {
  ...
  return (
      ...
      >
        <div ref={ref} className="service-card" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} onClick={handleClick} style={{ '--card-gradient': service.gradient }}>
...
const Home = () => {
  ...
  return (
      <div className={`hd-main-content-inner ${isDark ? 'hd-dark' : 'hd-light'}`}>
            ...
            <motion.div className="hd-hero-slideshow" initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4, duration: 0.8 }}>
              ...
              <div className="hd-slide-indicators">
                {HERO_SLIDES.map((_, idx) => (
                    <button
                        key={idx}
                        className={`hd-slide-dot ${currentSlide === idx ? 'active' : ''}`}
        ...
        <MoodSelector isDark={isDark} />
        <DealsBanner isDark={isDark} />
