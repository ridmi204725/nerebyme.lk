...
export const getVenues = async (req, res) => {
  try {
    ...
    const ticketSubCats = ["Concerts", "Musical Shows", "Stage Plays", "Festivals", "Exhibitions", "සංගීත ප්‍රසංග", "සංගීත සංදර්ශන", "වේදිකා නාට්‍ය", "උත්සව", "ප්‍රදර්ශන"];
    ...
    return res.status(200).json({ success: true, count: formattedVenues.length, data: formattedVenues });
  } catch (error) {
